    ...
    <section id="about" className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-600 via-purple-400 to-transparent"></div>
            ...
            {experience.map((exp, index) => (
              ...
              >
                ...
                <div className={`flex-1 ml-20 md:ml-0 ${index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:pl-12'}`}>
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-purple-500/30 hover:shadow-xl transition-shadow">
                    {/* Period Badge */}
                    <div className={`inline-block px-4 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-sm font-semibold mb-4`}>
                      {exp.period}
                    </div>
